...
export const BottomNav: React.FC<BottomNavProps> = ({
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 pb-safe bg-[#faf8ff]/95 backdrop-blur-xl shadow-[0_-4px_20px_rgba(19,27,46,0.06)] rounded-t-2xl border-t border-[#eaedff]">
