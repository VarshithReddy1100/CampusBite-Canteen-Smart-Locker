  ...
  return (
    <div className="flex flex-col w-full px-4 pb-28 gap-4 pt-1">
      ...
      <div className="flex items-center justify-between pt-2">
        <div>
          <h1 className="text-xl font-extrabold text-[#131b2e]">Campus ID &amp; Wallet</h1>
          <p className="text-xs text-[#594139]">Contactless Dining Pass &amp; Locker Access</p>
        </div>
        <div className="flex items-center gap-1 bg-[#6cf8bb]/40 text-[#005236] px-2.5 py-1 rounded-full text-xs font-bold">
      ...
      {/* Tabs */}
      <div className="flex items-center bg-[#eaedff] p-1 rounded-2xl gap-1">
        <button
      ...
      {activeTab === 'card' && (
        <>
          ...
          <div
            ...
            className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#131b2e] via-[#283044] to-[#ab3500] p-5 text-white shadow-xl cursor-pointer active:scale-[0.99] transition-all border border-white/10"
          >
            {/* Holographic Watermark */}
            <div className="absolute -top-12 -right-12 w-40 h-40 rounded-full bg-white/10 blur-2xl pointer-events-none"></div>

            <div className="flex items-start justify-between">
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-[24px] text-[#ff6b35]">school</span>
                <div>
                  <span className="text-xs font-extrabold tracking-wider uppercase block text-white/90">
                    State University
                  </span>
              ...
              <div className="flex items-center gap-1 bg-white/15 backdrop-blur-md px-2 py-0.5 rounded-full text-[10px] font-bold">
          ...
          <div className="grid grid-cols-2 gap-3">
            {/* Dining Dollars */}
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-[#eaedff] flex flex-col justify-between">
              ...
              <div className="mt-2">
                ...
                <button
                  ...
                  className="mt-2 w-full py-1.5 rounded-xl bg-[#ffdbd0] text-[#ab3500] text-xs font-bold hover:bg-[#ff6b35] hover:text-white transition-colors"
                >
                  + Add Funds
                </button>
              </div>
          ...
          <div className="bg-white rounded-2xl p-4 shadow-sm border border-[#eaedff] flex items-center justify-between">
            <div className="flex items-center gap-3 min-w-0">
              <div className="w-10 h-10 rounded-xl bg-[#ff6b35]/15 text-[#ab3500] flex items-center justify-center flex-shrink-0">
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-full bg-[#ff6b35] text-white text-xs font-bold shadow-xs hover:bg-[#ab3500] transition-colors flex-shrink-0"
            >
              Open Pass
            </button>
          </div>
      ...
      {activeTab === 'history' && (
        <div className="flex flex-col gap-3">
          <h3 className="text-sm font-bold text-[#131b2e]">Recent Locker Transactions</h3>
          <div className="bg-white rounded-2xl divide-y divide-[#eaedff] border border-[#eaedff] shadow-sm overflow-hidden">
            <div className="p-3.5 flex items-center justify-between">
              ...
              <div className="flex flex-col items-end">
                ...
                <span className="text-[10px] text-[#006c49] font-semibold">Ready</span>
              </div>
            </div>
      ...
      {activeTab === 'dietary' && (
        <div className="flex flex-col gap-3">
          <h3 className="text-sm font-bold text-[#131b2e]">Verified Dietary Profile</h3>
            ...
            <div className="flex items-center justify-between p-3 bg-[#f2f3ff] rounded-xl">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[#594139]">Filter all meals by campus Halal board</p>
                </div>
              </div>
              <span className="text-xs font-bold text-[#006c49]">Active</span>
            </div>
            ...
            <div className="flex items-center justify-between p-3 bg-[#f2f3ff] rounded-xl">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[#594139]">Warn on cross-contamination menus</p>
                </div>
              </div>
              <span className="text-xs font-bold text-[#ab3500]">Alert On</span>
            </div>
            ...
            <div className="flex items-center justify-between p-3 bg-[#f2f3ff] rounded-xl">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[#594139]">Return reusable bins to locker pods for +20 pts</p>
                </div>
              </div>
              <span className="text-xs font-bold text-[#006c49]">Enrolled</span>
            </div>
          </div>
        </div>
      )}
      ...
      {showTopUpModal && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl p-5 w-full max-w-sm shadow-2xl border border-[#eaedff] animate-fade-in">
